		...
		<div className="border-t border-white/5 p-4 bg-transparent backdrop-blur-sm relative">
			...
			{typingUsers.length > 0 && (
				<div className="absolute -top-6 left-6 animate-in fade-in slide-in-from-bottom-1 duration-300">
					<p className="text-[10px] text-[#4FA1D8] font-bold italic tracking-tight bg-black/40 px-2 py-0.5 rounded-full backdrop-blur-sm border border-[#4FA1D8]/20">
						{getTypingText()}
					</p>
				</div>
			)}
			...
			{replyTo && (
				<div className="mb-2 animate-in slide-in-from-bottom-2 duration-200">
					<div className="flex items-center gap-3 bg-white/5 rounded-xl border border-white/10 p-2 pr-1 select-none">
						<div className="w-1.5 self-stretch bg-[#4FA1D8] rounded-full" />
						<div className="flex-1 min-w-0">
							<p className="text-[10px] font-bold text-[#4FA1D8] uppercase tracking-tighter">
			...
			<div className="flex items-end gap-2 pr-1">
				...
				<div className="flex-1 relative">
					<textarea
						...
						className={cn(
							...
							"focus:outline-none focus:border-[#4FA1D8]/50 focus:bg-white/[0.08] transition-all",
				...
				<button
					...
					className={cn(
						...
						value.trim() 
							? "bg-gradient-to-tr from-[#4FA1D8] to-[#7B5CFF] text-white scale-100 opacity-100" 
