...
COMMENT ON SCHEMA "app" IS 'Funciones core multi-tenant para RLS: current_tenant_id, user_has_role, get_tenant_timezone.';
...
COMMENT ON SCHEMA "platform" IS 'Infra de auditoría y administración de plataforma: platform_users, roles, permisos, funciones de auditoría y triggers.';
...
DROP MATERIALIZED VIEW IF EXISTS "public"."daily_dashboard_kpis";
...
DROP MATERIALIZED VIEW IF EXISTS "public"."vw_booking_overview_mat";
...
DROP MATERIALIZED VIEW IF EXISTS "public"."vw_customer_summary";
...
-- Added minimal comments for public views
