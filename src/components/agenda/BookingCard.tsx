...
export function BookingCard({
  ...
  const baseClasses = cn(
    ...
    "rounded-3xl shadow-[0_16px_42px_rgba(0,0,0,0.38)]",
        ...
        <div className="pl-4 pr-3 py-2.5 space-y-2">
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-center gap-2 min-w-0 flex-1">
              <div className="h-8 w-8 rounded-full bg-white/12 border border-white/15 flex items-center justify-center text-xs font-semibold text-white/90">
            ...
            <div className="flex flex-col items-end gap-1 flex-shrink-0">
              <div className="px-2 py-1 rounded-full bg-white/10 text-[11px] font-mono text-white/90 border border-white/15 leading-none">
                {startTime} - {endTime}
              </div>
              <div className={cn(
          ...
          <div className="flex items-center justify-between gap-2 text-[11px] text-white/70 leading-tight">
          ...
          <div className="flex items-center justify-between text-[11px] text-white/70 gap-2">
            {booking.staff ? (
              <div className="flex items-center gap-2 min-w-0">
    ...
    >
      ...
      <div className="p-2.5 space-y-1">
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0">
            <div className="w-8 h-8 rounded-full bg-white/10 border border-white/10 flex items-center justify-center text-[11px] font-semibold text-white/90">
              {(booking.customer?.name || "").charAt(0) || "C"}
            </div>
        ...
        <div className="flex items-center justify-between gap-2 text-[11px] text-white/70">
          ...
          {booking.service?.duration_min && (
            <span className="px-2 py-0.5 rounded-full bg-white/10 text-white/70 border border-white/10">
              {booking.service.duration_min}min
            </span>
          )}
        </div>
        ...
        <div className="flex items-center justify-between gap-2 text-[11px] text-white/70">
          {booking.staff ? (
            ...
            <span className="text-white/55">Sin asignar</span>
          )}
