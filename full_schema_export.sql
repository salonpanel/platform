...
CREATE OR REPLACE TRIGGER "Update Login Requests on Auth Users Update" AFTER UPDATE ON "auth"."users" FOR EACH ROW EXECUTE FUNCTION "supabase_functions"."http_request"('https://pro.bookfast.es/api/webhooks/supabase-auth', 'POST', '{"Content-type":"application/json","Authorization":"Bearer 9bdd0e25979563f99663668e9f8df7fdd759f3c623586227294bdb4eb6214b04"}', '{}', '5000');
